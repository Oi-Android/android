...
echo -e ""
echo -e "${grn}Building CyanogenMOD 12${txtrst}"
...
if [ "$opt_clean" -eq 1 ]; then
    ...
    . build/envsetup.sh && lunch "cm_$device-userdebug";
    make installclean >/dev/null
    echo -e ""
    echo -e "${bldblu}Out is installclean${txtrst}"
    echo -e ""
fi
